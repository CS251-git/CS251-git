...
unknown fuck
Aamir Khan
Faizan kuch bhi esko mat lo picture bigad jaegi kuch nahi aata ese 
Sharman Joshi
Kareena Kapoor
Faizan
Faizan ko mat lo ye bigaad deg a picture kuxhc nahi aata esko ch hain ye
Anmol
...
\subsection{Ending}
In the end all the lead stars in the movie are killed in AIR building where they were confessing murder of the minister.This just shows the current status of Indian politics.
Those individuals were out to send a message to the youth of the country to motivate them to take steps to improve the situation and hopefully they would succed one day.
\end{document}
